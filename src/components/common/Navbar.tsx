      ...
      <div className="flex items-center justify-between max-w-4xl mx-auto px-4 lg:px-6">
        ...
        {session && (
          <Menu as="div" className="relative">
            <Menu.Button className="p-1.5 inline-flex items-center rounded-lg hover:bg-gray-800 text-gray-300 hover:text-white transition-colors duration-200">
              <span className="sr-only">Open user menu</span>
              <div
                aria-hidden="true"
                className="uppercase inline-flex items-center justify-center w-7 h-7 rounded-full bg-gray-900"
              >
                <span className="text-xs font-medium">{userTag.charAt(0)}</span>
              </div>
